(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))e(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&e(o)}).observe(document,{childList:!0,subtree:!0});function a(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function e(t){if(t.ep)return;t.ep=!0;const n=a(t);fetch(t.href,n)}})();(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();class c{constructor(){this.initVanta(),this.initializePortfolio(),this.setupScrollNavigation()}initVanta(){window.VANTA.TRUNK({el:"#background",mouseControls:!0,touchControls:!0,gyroControls:!1,minHeight:window.innerHeight,minWidth:window.innerWidth,scale:1,scaleMobile:1,color:16711755,backgroundColor:141130,spacing:1,chaos:1.75,speed:1.5})}initializePortfolio(){const i=document.querySelector(".main-container"),a=this.createHeroSection(),e=this.createAboutSection(),t=this.createExperienceSection(),n=this.createProjectsSection(),o=this.createContactSection(),l=this.createNavigation();i.appendChild(a),i.appendChild(e),i.appendChild(t),i.appendChild(n),i.appendChild(o),i.appendChild(l)}createHeroSection(){const i=document.createElement("section");return i.id="home",i.className="hero-section min-h-screen snap-start flex items-center justify-center relative",i.innerHTML=`
        ...
        `,setTimeout(()=>{const a=i.querySelector(".hero-title"),e=i.querySelector(".hero-subtitle"),t=i.querySelector(".hero-description");a.classList.add("animate-fade-in"),e.classList.add("animate-fade-in-delay-1"),t.classList.add("animate-fade-in-delay-2"),window.gsap&&gsap.to(i.querySelector(".scroll-dot"),{y:24,duration:1.5,repeat:-1,yoyo:!0,ease:"power1.inOut"})},100),i}createNavigation(){const i=document.createElement("nav");return i.className="navigation",i.innerHTML=`
            ...
            <div class="w-full flex flex-col items-center justify-center">
                <div class="w-full flex flex-col items-center justify-center max-w-7xl mx-auto px-4">
                    ...
                    <div class="mt-20 flex flex-wrap gap-7 justify-center">
                        ${d.map((a,e)=>`
                            <div class="project-card opacity-0 xs:w-[360px] w-full" data-github="${a.github}">
                                <div class="bg-[#1d1836] p-5 rounded-2xl h-full hover:bg-[#2a2449] transition-all duration-300">
                                    ...
                                    <div class="mt-5">
                                        <h3 class="text-white font-bold text-[24px]">${a.title}</h3>
                                        <p class="mt-2 text-secondary text-[14px]">${a.description}</p>
                                    </div>
        ...
        `,setTimeout(()=>{const a=i.querySelectorAll(".project-card");a.forEach(e=>{e.addEventListener("click",function(){const t=this.getAttribute("data-github");console.log("Clicked card, URL:",t),t&&window.open(t,"_blank")}),e.addEventListener("mouseenter",()=>{e.style.transform="translateY(-10px)",e.style.transition="all 0.3s ease"}),e.addEventListener("mouseleave",()=>{e.style.transform="translateY(0)"})}),VanillaTilt.init(a,{max:25,speed:400,glare:!0,"max-glare":.5})},100),i}createContactSection(){const i=document.createElement("section");return i.id="contact",i.innerHTML=`
            <div class="w-full flex flex-col items-center justify-center max-w-7xl mx-auto px-4">
        ...
        `,i}setupScrollNavigation(){this.sections=[{id:"home"},{id:"about"},{id:"experience"},{id:"projects"},{id:"contact"}];const i={root:null,threshold:.5,rootMargin:"0px"},a=new IntersectionObserver(e=>{e.forEach(t=>{if(t.isIntersecting){const n=t.target.id;document.querySelectorAll(".nav-dot").forEach(l=>{l.classList.remove("active")});const o=document.querySelector(`[data-section="${n}"]`);o&&o.classList.add("active")}})},i);document.querySelectorAll(".nav-dot").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const n=e.getAttribute("data-section"),o=document.getElementById(n);console.log("Clicking dot for section:",n),console.log("Found section:",o),o&&o.scrollIntoView({behavior:"smooth"})})}),this.sections.forEach(({id:e})=>{const t=document.getElementById(e);t&&a.observe(t)})}createNavDots(){const i=document.createElement("nav");i.className="fixed right-5 top-1/2 transform -translate-y-1/2 z-50",i.innerHTML=`
